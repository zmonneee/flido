...
public class TerrainSpawn : MonoBehaviour
{
    ...
    public TerrainData datas;

    // Start is called before the first frame update

     public void Awake()
    {
        Instantiate(datas).name = "TerrainBackup";
        ...
        //terreno.GetComponentInChildren<Terrain>().terrainData = TerrainDataCloner.Clone(datas);
        //terreno.GetComponentInChildren<Terrain>().terrainData = datas;
        //terreno.GetComponentInChildren<TerrainCollider>().terrainData = datas;
